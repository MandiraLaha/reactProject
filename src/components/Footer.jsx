...
function Footer() {
  return (
    <div className=" flex gap-5 w-full h-screen bg-zinc-100 text-[#212121] p-20 font-['Founders_Grotesk_X_Condensed']">
      ...
      <div className="w-1/2">
        ...
        <div className="dets flex gap-5 underline font-['Neue_Montreal'] mt-100">
          <a className="block text-[1.5vw] " href="#">
            Facebook
          </a>
          <a className="block text-[1.5vw] " href="#">
            Instagram
